...
public class UserQuery {
    ...
    public static final String ADD_USER = "INSERT INTO my_user (name, surname, fin, serial_no, departure, registration_date, expiration_date, payment_amount, status) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)";
